...
<body>
 <div class="container-fluid-0">
  <div class="container-fluid" id="section0">
   ...
   <div class="row text-center" id="article1">
                <div class="col-md-4">
                    <img id="article-photo"src="<?= base_url("assets/image/kirito.jpg")?>" alt="" class="">
    </div>  
    <div class="col-md-8">
     <h1 id="arttittle">Article Topik #1<h1>
      ...
      <h2 id="category">category1</h2>
            ...
            <div class="row text-center" id="article2">
                <div class="col-md-4">
                    <img id="article-photo"src="<?= base_url("assets/image/kirito.jpg")?>" alt="" class="">
    </div>
    <div class="col-md-8">
