	...
	<div class="container-fluid" id="section1">
		...
		<form action="<?php echo site_url('Article/searchArticleAdmin') ?>" method="get" class="navbar-form">
			<div class="form-group input-group">
				...
				?>
				<input id="search" type="text" name="searchArticle" value="<?= $_GET["title"] ?>" class="form-control"
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<div class="detail">
							<a href="" data-toggle="modal" data-target="#DetailsArticle<?= $article['id'] ?>"><img
			...
			<div class="modal fade justify-content-center" id="addArticle" role="dialog">
				<div class="modal-dialog bg-modal">
					<div class="modal-content">
						...
						<form action="<?= site_url('Article/add_Article') ?>" method="post"
							enctype="multipart/form-data" class="row" id="formInput">
							...
							<textarea form="formInput" name="description" cols="30" rows="5"
				...
				<div class="modal-dialog bg-modal">
					<div class="modal-content">
						...
						<form action="<?php echo site_url('Article/update_Article/'.$article['id']) ?>" method="post"
							...
							<div class="topic-title desc">Description</div>
							<textarea class="form-control" name="description" id="formEdit" cols="30"
				...
				<div class="modal-dialog bg-modal">
					<div class="modal-content">
						...
						<form action="<?php echo site_url('Article/load_AdminArticle') ?>" method="post"
							...
							<div class="col-md-7" id="inputan">
								<div class="topic-title">Article Name</div>
								<input type="text" name="title" class="form-control" disabled="true"
									value="<?= $article['title'] ?>">
								<div class="topic-title">Category</div>
								<input type="text" name="category" class="form-control" disabled="true"
									value="<?= $article['category'] ?>">
							</div>
							<div class="topic-title desc">Description</div>
							<textarea class="form-control" name="description" id="formDetail" cols="30" rows="5"
